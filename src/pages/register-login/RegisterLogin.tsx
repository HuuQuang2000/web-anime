        ...
        <div className="w-full h-full">
            ...
            <div className="p-[16px]">
                <div className="flex justify-center justify-items-center gap-x-[8px]">
                    <Link to="/login">
                        <div className="px-[32px] py-[8px] rounded-[6px] border-[2px] border-[#43B0B0] text-[#43B0B0] capitalize cursor-pointer">
                            log in
                        </div>
                    </Link>
                    <Link to="/register/register-step-2">
                        <div className="px-[32px] py-[8px] rounded-[6px] border-[2px] border-[#43B0B0] text-[#ffffff] bg-[#43B0B0] uppercase cursor-pointer">
                            register
                        </div>
                    </Link>
                </div>
